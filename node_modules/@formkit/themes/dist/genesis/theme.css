...
input[type="date"].formkit-input::-webkit-calendar-picker-indicator {
      padding-top: 0;
      padding-bottom: 0;
      font-size: 0.875em;
    }
input[type="date"].formkit-input::-webkit-datetime-edit {
      line-height: 1;
      overflow: visible;
    }
...
input[type="radio"].formkit-input ~ .formkit-decorator {
      border-radius: var(--fk-border-radius-full)
    }
input[type="radio"].formkit-input ~ .formkit-decorator::before {
        width: 50%;
        height: 50%;
        top: 50%;
        left: 50%;
...
[data-type="checkbox"] .formkit-input ~ .formkit-decorator::before, [data-type="radio"] .formkit-input ~ .formkit-decorator::before {
...
[data-type="checkbox"] .formkit-input:checked ~ .formkit-decorator::before, [data-type="radio"] .formkit-input:checked ~ .formkit-decorator::before {
        border-color: var(--fk-color-border-focus);
      }
...
[data-type="file"] .formkit-no-files + .formkit-file-item, [data-type="file"] .formkit-file-item + .formkit-file-item {
      margin-top: var(--fk-padding-input-t);
    }
[data-type="file"] .formkit-no-files::before, [data-type="file"] .formkit-file-item::before {
      content: "";
      display: block;
      width: 14px;
      height: 16px;
...
[data-type="file"] .formkit-remove-files {
    position: absolute;
...
[data-type="file"] .formkit-remove-files:hover {
      color: var(--fk-color-danger);
    }
[data-type="file"] .formkit-file-item .formkit-remove-files {
    position: absolute;
    margin-left: auto;
    margin-right: 0;
    bottom: auto;
...
[data-type="file"] .formkit-file-item .formkit-remove-files::after {
      content: "";
      display: block;
      width: 30px;
      height: 30px;
      ...
      -webkit-clip-path: path("M16.41,16l3.3-3.29a1,1,0,0,0-1.42-1.42L15,14.59l-3.29-3.3a1,1,0,0,0-1.42,1.42L13.59,16l-3.3,3.29a1,1,0,0,0,0,1.42,1,1,0,0,0,1.42,0L15,17.41l3.29,3.3a1,1,0,0,0,1.42,0,1,1,0,0,0,0-1.42Z");
...
[data-type="file"] .formkit-file-item .formkit-remove-files:hover::after {
