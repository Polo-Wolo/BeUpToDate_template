...
var script = defineComponent({
    ...
    init() {
      ...
      if (data && data.length > 0) {
        ...
        data.forEach((rawItem, index) => {
          ...
          const item = __spreadProps(__spreadValues({}, rawItem && rawItem.content !== void 0 ? rawItem : {
            content: rawItem
          }), {
            active,
            bottom: false,
  ...
  render() {
    return h(this.tag, __spreadValues(__spreadValues({
      class: {
        "vue-carousel": true,
      ...
      }, this.list.map((item, index) => h("li", __spreadValues({
        "data-slide-to": index,
        class: {
...
// dep:@chenfengyuan_vue-carousel
var chenfengyuan_vue_carousel_default = script;
export {
  chenfengyuan_vue_carousel_default as default
};
